package Presentation.UserView.EmployeeView.CustomerView.CustomerItem.CustomerDetail;
...
public class CustomerDetail extends JPanel {
    ...
    public CustomerDetail(CustomerPOJO ca){
        ...
        address.setBounds(30,100,500,30);
        address.setFont(new Font("Inter",Font.PLAIN,15));
        address.setForeground(Color.WHITE);

        age = new JLabel("Address: "+ ca.getAddress());
        age.setBounds(500,100,100,30);
        age.setFont(new Font("Inter",Font.PLAIN,15));
