package Presentation.UserView.AdminView.Revenue.CategoryRevenue;

import Business.BookBU;
import Business.CategoryBU;
import Business.CategoryRevenueBU;
...
public class CategoryRevenue extends JPanel {
    JLabel title = new JLabel("Category Revenue");
    MyButton sortBtn = new MyButton("Sort");
    CategoryRevenueBU bu = new CategoryRevenueBU();
    ...
    CategoryBU categoryBU = new CategoryBU();
    ...
    public CategoryRevenue() {
        ...
        List<CategoryPOJO> categories = categoryBU.getAll();
        String book[] = new String[categories.size()];

        for (int i = 0; i < categories.size(); i++) {
            book[i] = categories.get(i).getName();
        }
        ...
        bookName.setBounds(120, 82, 230, 26);
