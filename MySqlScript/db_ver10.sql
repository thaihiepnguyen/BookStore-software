...
(11,'Tào Tháo','101 Nguyễn Trãi','user11@gmail.com','0735276722','40', true),
(12,'Quanh Bâng Man','112 Nguyễn Trãi','user12@gmail.com','0735276722','40', true),
(13,'Tuyền Quang','113 Nguyễn Trãi','user13@gmail.com','0735276722','40', true),
(14,'Lã Bá Sặc','114 Nguyễn Trãi','user14@gmail.com','0735276722','40', true),
(15,'Công Tôn Quân','115 Nguyễn Trãi','user15@gmail.com','0735276722','40', true),
(16,'Tôn Thị Hương','116 Nguyễn Trãi','user16@gmail.com','0735276722','40', true),
(17,'Bùi Văn Tráng','117 Nguyễn Trãi','user17@gmail.com','0735276722','40', true),
(18,'Lý Méc Si','260 Đinh Tiên Nguyễn Trãi','user18@gmail.com','0735276722','40', true),
(19,'Trần Đức Công','90/91 Nguyễn', 'user19@gmail.com','0735276722','40', true),
(20,'Lê Thị Nam Như','100 Nguyễn Trãi','user20@gmail.com','0735276722','40', true);
...
(1,'Happy Aniversary','This promotion applies for celebration - discount 15%','2022-12-01','2022-12-04',false, 0.15, 10, true, false),
(2,'Noel with fun','Discount 10% for membership','2022-12-06','2023-01-10',true, 0.1, 5, true, false),
(3,'Love membership','Discount 12%','2023-01-03','2023-01-12', true, 0.12, 10,true, false),
(4,'Cheap books','Discount 23%','2023-02-16','2023-02-30', false, 0.23, 20,true, true);
...
(5,'nguyenthanh','12345678promotion','Nguyễn','Thanh','Nam','100 Cao Thắng, phường 4, quận 3',2,'2000-03-22','09378555',  '', true),
...
(11,'1','1','Thái','Thái Thái','Nam','123 Điện Biên Phủ, phường 3, quận 5',1 ,'2002-02-03','0124143242', '', true);
...
(1, 1, 1, "2022-10-02 17:23:04", 1),
(2, 6, 5, "2022-10-02 13:30:04", 3),
(3, 8, 4, "2022-10-04 08:49:14", 4),
(4, 7, 5, "2022-10-05 07:30:04", 4),
(5, 10, 8, "2022-10-06 13:30:04", 3),
(6, 5, 7, "2022-10-06 08:30:04", 1),
(7, 2,  9, "2022-11-01 15:30:04", 1),
(8, 4, 1, "2022-11-01 08:30:04", 1),
(9, 9, 5, "2022-11-02 12:15:04", 1),
(10, 4, 8, "2022-11-03 12:15:04", 1),
(11, 11, 8, "2022-11-04 12:15:04", 1),
(12, 12, 1, "2022-11-07 12:15:04", 1),
(13, 14, 7, "2022-11-09 12:15:04", 1),
(14, 14, 3, "2022-11-09 12:15:04", 2),
(15, 20, 2, "2022-11-10 12:15:04", 2),
(16, 3, 4, "2022-11-11 12:15:04", 2),
(17, 2, 4, "2022-12-01 12:15:04", 2),
(18, 18, 8, "2022-12-02 12:15:04", 2),
(19, 18, 6, "2022-12-03 12:15:04", 2),
(20, 18, 7, "2022-12-05 12:15:04", 3),
(21, 20, 7, "2022-12-07 12:15:04", 3),
(22, 15, 10, "2022-12-08 12:15:04", 3),
(23, 15, 2, "2022-12-10 12:15:04", 3),
(24, 15, 2, "2022-12-12 12:15:04", 3),
(25, 4, 2, "2022-12-12 12:15:04", 3),
(26, 15, 3, "2022-12-14 12:15:04", 3),
(27, 19, 4, "2022-12-15 12:15:04", 3),
(28, 10, 4, "2022-12-16 12:15:04", 3),
(29, 15, 6, "2021-12-16 12:15:04", 4),
(30, 18, 5, "2022-12-18 12:15:04", 4),
(31, 17, 5, "2022-12-18 12:15:04", 4),
(32, 16, 6, "2022-12-27 12:15:04", 4),
(33, 12, 7, "2022-12-27 12:15:04", 4),
(34, 12, 11, "2022-12-27 12:15:04",4),
(35, 12, 10, "2022-12-28 12:15:04", 4),
(36, 12, 9, "2022-12-28 12:15:04", 4),
(37, 3, 7, "2023-01-01 12:15:04", 4),
(38, 9, 3, "2023-01-02 12:15:04", 4),
(39, 12, 2, "2023-01-05 12:15:04", 3),
(40, 12, 1, "2023-01-06 12:15:04", 1);
...
--         DECLARE i INT;
-- 		DECLARE j INT;
--         DECLARE number_book INT;
--         SET i = 1;
--         WHILE i <= NumRows DO
--             SET number_book = RAND()*(3-1)+1;
--             SET j = 1;
--             
--             WHILE j <= number_book DO
-- 				INSERT INTO order_book (order_id, book_id, quantity) VALUES (i, RAND()*((j * 10)- (j*10 - 9)) + (j*10 - 9), RAND()*(3-1)+1);
--                 SET j = j + 1;
-- 			END WHILE;
--             SET i = i + 1;
--         END WHILE;
