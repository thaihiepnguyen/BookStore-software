...
//            String query = "SELECT * FROM promotion\n";
            ResultSet rs = db.findAll("promotion");
            while (rs.next()) {
                int id = rs.getInt("id");
...
//            statement = connection.createStatement();
            ...
            PreparedStatement updateEXP2 = db.conn.prepareStatement("delete from pm_book where pm_id=" + id);
            updateEXP2.execute();
...
//            statement = connection.createStatement();
            ...
            ResultSet rsCount = db.statement.executeQuery(sqlCount);
            int quantity_book = 0;
            if(rsCount.next()) {
